...
-- 目标: 腾讯云 MySQL 8.0
-- 数据库: baobeileiting
-- 变更: records 表 drink_id 允许 NULL，新增 custom_brand/custom_name 支持自定义饮品
-- 创建日期: 2026-07-12
-- ============================================================
...
--    v2.1.2: drink_id 允许 NULL，新增 custom_brand/custom_name 支持自定义饮品
-- ============================================================
CREATE TABLE IF NOT EXISTS records (
  id          INT             PRIMARY KEY AUTO_INCREMENT,
  user_id     VARCHAR(36)     NOT NULL COMMENT '用户 UUID',
  drink_id    INT             NULL COMMENT '饮品（NULL 表示自定义饮品）',
  custom_brand VARCHAR(100)   NULL COMMENT '用户自定义品牌',
  custom_name  VARCHAR(100)   NULL COMMENT '用户自定义饮品',
