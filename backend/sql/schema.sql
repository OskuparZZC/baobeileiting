...
CREATE TABLE IF NOT EXISTS users (
  ...
  student_id  VARCHAR(50)     COMMENT '学号（允许为空）',
  avatar      VARCHAR(255)    COMMENT '头像 URL',
  password_hash VARCHAR(255)  COMMENT '密码哈希（预留认证）',
  created_at  DATETIME        DEFAULT CURRENT_TIMESTAMP,
  updated_at  DATETIME        DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- ============================================================
-- 4. user_stats - 用户游戏化统计（1:1 users）
-- ============================================================
CREATE TABLE IF NOT EXISTS user_stats (
  ...
  last_record_date        DATE  COMMENT '最后记录日期',

  -- 统计
  total_records           INT   DEFAULT 0 COMMENT '总记录数',
  total_bounties_published INT  DEFAULT 0 COMMENT '发布悬赏数',
  total_bounties_completed INT  DEFAULT 0 COMMENT '完成悬赏数',
...
CREATE TABLE IF NOT EXISTS bounties (
  ...
  -- 参与者
  publisher_id  INT           NOT NULL COMMENT '发布者',
  acceptor_id   INT           COMMENT '接单者',
...
-- ============================================================
-- 11. user_achievements - 用户成就进度（预留）
-- ============================================================
